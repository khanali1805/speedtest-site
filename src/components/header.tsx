    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1100px] items-center justify-between px-6 py-3">
        <Link href="/" className="flex items-center gap-2.5">
          {/* Logo - FIXED: No black background, white/transparent */}
          ...
          <span className="rounded-full bg-[#1e3a8a] px-2 py-0.5 text-[10px] font-bold text-white">.online</span>
        </Link>
        ...
        <Link href="/speed-test" className="rounded-full bg-[#1e3a8a] px-4 py-1.5 text-[13px] font-semibold text-white hover:bg-blue-800">
          Test Now
        </Link>
      </div>
    </header>
